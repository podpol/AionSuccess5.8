...
public class Account {
    ...
    private Timestamp prestigeSociety;
    
    private int vipLevel;
    private String vipEffect;
    ...
    public Timestamp getPrestigeSociety() {
      return prestigeSociety;
    }
    
    public void setPrestigeSociety(Timestamp prestigeSociety) {
    ...
    public String getVipEffect() {
      return vipEffect;
    }
    
    public void setVipEffect(String vipEffect) {

    ...
    protected void runImpl() {
        ...
        switch (type) {
            ...
            case 3:
                ...
                account.setVipEffect(vipEffects);
                account.setVipTime(new Timestamp(vipTime));
        }
        result = DAOManager.getDAO(AccountDAO.class).updateAccount(account);
        sendPacket(new SM_LS_CONTROL_RESPONSE(type, result, playerName, account.getId(), param, adminName, vipLevel, vipEffects, new Timestamp(vipTime)));
    }
}

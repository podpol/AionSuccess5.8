...
public class SM_ACCOUNT_AUTH_RESPONSE extends GsServerPacket {
     ...
     * new packets
     */
    private long prestigeSociety;
	private int vipLevel;
	private String vipEffects;
     ...
     * @param luna
     */
    public SM_ACCOUNT_AUTH_RESPONSE(int accountId, boolean ok, String accountName, byte accessLevel, byte membership, long toll, long luna, byte isReturn, long prestigeSociety, int vipLevel, String vipEffects, long vipTime) {
        ...
        this.prestigeSociety = prestigeSociety;
        this.vipLevel = vipLevel;
        this.vipEffects = vipEffects;

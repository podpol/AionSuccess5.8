...
public class FallenPoetaInstance extends GeneralInstanceHandler
{
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			break;
			case 703292: //Dark Spore Road Iron Fence.
			    despawnNpc(npc);
			...
			break;
			case 703291: //Dark Spore Road Iron Fence.
			    despawnNpc(npc);
			...
			break;
			case 703290: //Dark Spore Road Iron Fence.
			    despawnNpc(npc);
	...
	private void SpawnFallenPoetaRace() {
		...
		spawn(Kantil_Animar, 299.75082f, 916.8568f, 105.5561f, (byte) 106);

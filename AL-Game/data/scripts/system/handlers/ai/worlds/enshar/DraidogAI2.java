...
@AIName("draidog")
public class DraidogAI2 extends NpcAI2
{
	@Override
    protected void handleDialogStart(Player player) {
        //Bomire Territory Village Infiltration Rift Corridor Key.
		if (player.getInventory().getFirstItemByItemId(185000235) != null) {

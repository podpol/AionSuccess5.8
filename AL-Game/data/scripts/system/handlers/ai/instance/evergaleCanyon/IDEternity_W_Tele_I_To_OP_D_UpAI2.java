...
@AIName("IDEternity_W_Tele_I_To_OP_D_Up")
public class IDEternity_W_Tele_I_To_OP_D_UpAI2 extends ActionItemNpcAI2
{
	@Override
	...
	protected void handleUseItemFinish(Player player) {
		switch (getNpcId()) {
		    case 835292: //IDEternity_W_Tele_I_To_OP_D_Up.
	...
	private void IDEternity_W_Tele_I_To_OP_L_Up() {
		despawnNpc(835292);
		despawnNpc(835454);
		AI2Actions.deleteOwner(IDEternity_W_Tele_I_To_OP_D_UpAI2.this);

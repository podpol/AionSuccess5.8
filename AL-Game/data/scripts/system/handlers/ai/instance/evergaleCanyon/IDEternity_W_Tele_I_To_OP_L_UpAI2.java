...
@AIName("IDEternity_W_Tele_I_To_OP_L_Up")
public class IDEternity_W_Tele_I_To_OP_L_UpAI2 extends ActionItemNpcAI2
{
	@Override
	...
	protected void handleUseItemFinish(Player player) {
		switch (getNpcId()) {
		    case 835280: //IDEternity_W_Tele_I_To_OP_L_Up.
	...
	private void IDEternity_W_Tele_I_To_OP_D_Up() {
		despawnNpc(835280);
		despawnNpc(835453);
		AI2Actions.deleteOwner(IDEternity_W_Tele_I_To_OP_L_UpAI2.this);

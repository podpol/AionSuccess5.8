...
public class GoTo extends AdminCommand
{
	...
	public void execute(Player player, String... params) {
		...
		//(Need Client Patch)
		else if (destination.equalsIgnoreCase("katalam") || destination.equalsIgnoreCase("Katalam")) 
			goTo(player, 600050000, 361, 383, 281);
		else if (destination.equalsIgnoreCase("danaria") || destination.equalsIgnoreCase("Danaria")) 
			goTo(player, 600060000, 2545, 1699, 141);
		else if (destination.equalsIgnoreCase("Sarpan") || destination.equalsIgnoreCase("Sarpan"))
			goTo(player, 600020000, 1374, 1455, 600);
		else if (destination.equalsIgnoreCase("Tiamaranta") || destination.equalsIgnoreCase("Tiamaranta"))
		...
		else if (destination.equalsIgnoreCase("pandae2") || destination.equalsIgnoreCase("Dredgion Defense: Pandaemonium"))
		...
		//**4.7**//
			...
			goTo(player, 600090000, 743, 1156, 148);
		...
		else if (destination.equalsIgnoreCase("eye1")) //5.8
			goTo(player, 600040000, 754, 30, 1196);
		else if (destination.equalsIgnoreCase("eye2")) //5.8
			goTo(player, 600041000, 754, 30, 1196);
		//**Panesterra**//

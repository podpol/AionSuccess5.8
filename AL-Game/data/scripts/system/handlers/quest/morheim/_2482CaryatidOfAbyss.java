...
public class _2482CaryatidOfAbyss extends QuestHandler {
	...
	private final static int questId = 2482;
	...
	public void register() {
		qe.registerQuestNpc(204333).addOnQuestStart(questId);
		qe.registerQuestNpc(204333).addOnTalkEvent(questId);
		qe.registerQuestNpc(204210).addOnTalkEvent(questId);
		qe.registerQuestNpc(278018).addOnTalkEvent(questId);
		qe.registerQuestNpc(278020).addOnTalkEvent(questId);
	}

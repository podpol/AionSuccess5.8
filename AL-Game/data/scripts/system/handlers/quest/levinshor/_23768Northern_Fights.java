...
public class _23768Northern_Fights extends QuestHandler
{
    private final static int questId = 23768;
	
    public _23768Northern_Fights() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(235353).addOnKillEvent(questId);
    }

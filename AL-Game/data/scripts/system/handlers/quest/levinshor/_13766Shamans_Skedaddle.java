...
public class _13766Shamans_Skedaddle extends QuestHandler
{
    private final static int questId = 13766;
	
    public _13766Shamans_Skedaddle() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(235356).addOnKillEvent(questId);
    }

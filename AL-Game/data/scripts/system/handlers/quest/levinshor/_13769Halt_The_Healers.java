...
public class _13769Halt_The_Healers extends QuestHandler
{
    private final static int questId = 13769;
	
    public _13769Halt_The_Healers() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(235364).addOnKillEvent(questId);
    }

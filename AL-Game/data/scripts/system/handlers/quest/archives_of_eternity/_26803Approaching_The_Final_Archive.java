...
public class _26803Approaching_The_Final_Archive extends QuestHandler
{
    private final static int questId = 26803;
	private final static int[] IDEternity01Mobs = {220307, 220310, 220313, 220316, 220319, 220325, 220328, 220331};
	
    public _26803Approaching_The_Final_Archive() {
        super(questId);
    }
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        return defaultOnLvlUpEvent(env, 26802, true);
    }

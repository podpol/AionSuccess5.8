...
{
    private final static int questId = 25447;
    ...
    public void register() {
		...
		qe.registerQuestNpc(805411).addOnTalkEvent(questId); //Dukur.
		qe.registerQuestNpc(805411).addOnAtDistanceEvent(questId); //Dukur.
    }

...
public class _23846The_Enraged_Eastern_Guardian extends QuestHandler
{
    ...
    public void register() {
        qe.registerQuestNpc(806519).addOnQuestStart(questId); //Dyenstark.
        qe.registerQuestNpc(806519).addOnTalkEvent(questId); //Dyenstark.
		qe.registerQuestNpc(806519).addOnAtDistanceEvent(questId); //Dyenstark.
		for (int mob: Ab1132BossA) {

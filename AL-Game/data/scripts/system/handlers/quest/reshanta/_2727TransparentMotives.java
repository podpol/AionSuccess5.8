...
public class _2727TransparentMotives extends QuestHandler {
	...
	private final static int questId = 2727;
	...
	public void register() {
		...
		qe.registerQuestNpc(278000).addOnTalkEvent(questId);
		qe.registerQuestNpc(278013).addOnTalkEvent(questId);
		qe.registerQuestNpc(278102).addOnTalkEvent(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 278003) {
			...
			if (qs != null) {
				...
				else if (env.getDialogId() == 1009 && qs.getStatus() == QuestStatus.START) {
					qs.setQuestVar(2);

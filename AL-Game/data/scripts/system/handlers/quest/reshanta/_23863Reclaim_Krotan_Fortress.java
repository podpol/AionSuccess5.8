...
public class _23863Reclaim_Krotan_Fortress extends QuestHandler
{
    private final static int questId = 23863;
	
    public _23863Reclaim_Krotan_Fortress() {
        super(questId);
    }
	...
	public boolean onKillInWorldEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("KROTAN_REFUGE_400010000"))) {

...
public class _28974Protect_Bomire_Village extends QuestHandler
{
    private final static int questId = 28974;
	
    public _28974Protect_Bomire_Village() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(219746).addOnKillEvent(questId);
    }

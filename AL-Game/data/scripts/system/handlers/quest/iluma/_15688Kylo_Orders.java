...
public class _15688Kylo_Orders extends QuestHandler
{
    private final static int questId = 15688;
	
    public _15688Kylo_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806254).addOnAtDistanceEvent(questId);
    }

...
public class _15682Kornus_Orders extends QuestHandler
{
    private final static int questId = 15682;
	
    public _15682Kornus_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806100).addOnAtDistanceEvent(questId);
    }

...
public class _15687Cernia_Orders extends QuestHandler
{
    private final static int questId = 15687;
	
    public _15687Cernia_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806094).addOnAtDistanceEvent(questId);
    }

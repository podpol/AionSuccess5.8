...
public class _15520Topiary_Troubles extends QuestHandler
{
    private final static int questId = 15520;
	
    public _15520Topiary_Troubles() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(703069).addOnKillEvent(questId);
    }

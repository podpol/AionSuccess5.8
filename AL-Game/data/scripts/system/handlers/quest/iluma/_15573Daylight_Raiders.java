...
public class _15573Daylight_Raiders extends QuestHandler
{
    private final static int questId = 15573;
	
    public _15573Daylight_Raiders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(241257).addOnKillEvent(questId);
    }

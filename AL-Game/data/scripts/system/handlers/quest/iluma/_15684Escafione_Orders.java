...
public class _15684Escafione_Orders extends QuestHandler
{
    private final static int questId = 15684;
	
    public _15684Escafione_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806098).addOnAtDistanceEvent(questId);
    }

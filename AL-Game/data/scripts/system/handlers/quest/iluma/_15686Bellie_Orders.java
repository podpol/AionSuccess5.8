...
public class _15686Bellie_Orders extends QuestHandler
{
    private final static int questId = 15686;
	
    public _15686Bellie_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806091).addOnAtDistanceEvent(questId);
    }

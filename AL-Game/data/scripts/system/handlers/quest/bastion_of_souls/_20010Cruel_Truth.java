...
public class _20010Cruel_Truth extends QuestHandler
{
	public static final int questId = 20010;
	private final static int[] npcs = {806592, 806593, 806594, 703429, 703430, 731782};
	private final static int[] IDAb1EreBossLeader75Ah = {246544, 246545, 246546};
	
	public _20010Cruel_Truth() {
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
        ...
        if (env.getVisibleObject() instanceof Npc) {
			...
			if (targetId == 806592) { //IDAb1_Ere_Start_Vatiskhan_E.
			...
			} if (targetId == 806593) { //IDAb1_Ere_Manager_Front_Vatiskhan_E.
				switch (env.getDialog()) {
                    case USE_OBJECT: {
						if (var == 1) {
			...
			} if (targetId == 806594) { //IDAb1_Ere_Manager_Room_Vatiskhan_E.
				switch (env.getDialog()) {
					case START_DIALOG: {
						if (var == 5) {

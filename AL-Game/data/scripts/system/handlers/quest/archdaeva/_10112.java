...
public class _10112 extends QuestHandler
{
    public static final int questId = 10112;
	private final static int[] npcs = {805351, 806779, 703465};
    ...
    public void register() {
		...
		qe.registerQuestItem(182216232, questId); //천족 �?�바 구급�?�?.
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        return defaultOnLvlUpEvent(env, 10111, true);
    }
            ...
            if (targetId == 805351) { //Giscours.
                ...
                switch (env.getDialog()) {
				    case START_DIALOG: {
						...
						return defaultCloseDialog(env, 1, 2, false, false, 182216232, 1, 0, 0); //천족 �?�바 구급�?�?.
					} case CHECK_COLLECTED_ITEMS: {
						if (QuestService.collectItemCheck(env, true)) {
							removeQuestItem(env, 182216243, 5); //천족 보급품 �?�?.

...
public class _1314Anelimoutofwater extends QuestHandler {
	...
	private final static int questId = 1314;
	...
	public void register() {
		qe.registerQuestNpc(730023).addOnQuestStart(questId);
		qe.registerQuestNpc(730023).addOnTalkEvent(questId);
		qe.registerQuestNpc(730021).addOnTalkEvent(questId);

...
public class _15041Flak_From_The_Brohum extends QuestHandler
{
    ...
    public void register() {
		...
		qe.registerQuestNpc(235852).addOnKillEvent(questId);
		qe.registerQuestNpc(235853).addOnKillEvent(questId);
		qe.registerQuestNpc(235854).addOnKillEvent(questId);
		qe.registerQuestNpc(235855).addOnKillEvent(questId);
    }

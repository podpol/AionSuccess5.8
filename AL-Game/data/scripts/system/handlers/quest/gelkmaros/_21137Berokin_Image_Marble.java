...
public class _21137Berokin_Image_Marble extends QuestHandler
{
	private final static int questId = 21137;
	
	public _21137Berokin_Image_Marble() {
		super(questId);
	}
		...
		if (env.getVisibleObject() instanceof Npc) {
			...
			if (qs != null) {
				if (env.getDialog() == QuestDialog.START_DIALOG && qs.getStatus() == QuestStatus.START) {
					...
					removeQuestItem(env, 182207920, 1);
					qs.setQuestVar(1);

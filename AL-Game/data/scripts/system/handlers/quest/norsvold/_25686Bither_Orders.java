...
public class _25686Bither_Orders extends QuestHandler
{
    private final static int questId = 25686;
	
    public _25686Bither_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806103).addOnAtDistanceEvent(questId);
    }

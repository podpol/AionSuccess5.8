...
public class _25577Night_Hunting extends QuestHandler
{
    private final static int questId = 25577;
	
    public _25577Night_Hunting() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(241221).addOnKillEvent(questId);
    }

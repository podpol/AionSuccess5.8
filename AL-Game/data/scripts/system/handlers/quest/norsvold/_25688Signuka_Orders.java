...
public class _25688Signuka_Orders extends QuestHandler
{
    private final static int questId = 25688;
	
    public _25688Signuka_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806255).addOnAtDistanceEvent(questId);
    }

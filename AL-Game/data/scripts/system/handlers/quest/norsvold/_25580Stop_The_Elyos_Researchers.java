...
public class _25580Stop_The_Elyos_Researchers extends QuestHandler
{
    private final static int questId = 25580;
	
    public _25580Stop_The_Elyos_Researchers() {
        super(questId);
    }
    ...
    public void register() {
		...
		//To Do
		qe.registerQuestNpc(241244).addOnKillEvent(questId);
    }

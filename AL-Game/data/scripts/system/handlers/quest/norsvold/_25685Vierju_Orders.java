...
public class _25685Vierju_Orders extends QuestHandler
{
    private final static int questId = 25685;
	
    public _25685Vierju_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806108).addOnAtDistanceEvent(questId);
    }

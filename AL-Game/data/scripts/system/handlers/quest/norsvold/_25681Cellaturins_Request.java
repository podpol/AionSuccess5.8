...
public class _25681Cellaturins_Request extends QuestHandler
{
    private final static int questId = 25681;
	
    public _25681Cellaturins_Request() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806194).addOnTalkEvent(questId);
		qe.registerQuestNpc(806194).addOnAtDistanceEvent(questId);
    }

...
public class _25529Tale_Of_The_Howling_Daevas extends QuestHandler
{
    private final static int questId = 25529;
	
    public _25529Tale_Of_The_Howling_Daevas() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(703083).addOnKillEvent(questId);
    }

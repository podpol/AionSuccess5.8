...
public class _25571Children_Of_Anima extends QuestHandler
{
    private final static int questId = 25571;
	
    public _25571Children_Of_Anima() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(241199).addOnKillEvent(questId);
    }

...
public class _25570Featherfern_Safari extends QuestHandler
{
    private final static int questId = 25570;
	
    public _25570Featherfern_Safari() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(241197).addOnKillEvent(questId);
    }

...
public class _25682Pricornie_Orders extends QuestHandler
{
    private final static int questId = 25682;
	
    public _25682Pricornie_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806112).addOnAtDistanceEvent(questId);
    }

...
public class _25684Scorvion_Orders extends QuestHandler
{
    private final static int questId = 25684;
	
    public _25684Scorvion_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806110).addOnAtDistanceEvent(questId);
    }

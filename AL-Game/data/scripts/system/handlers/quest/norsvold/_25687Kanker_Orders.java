...
public class _25687Kanker_Orders extends QuestHandler
{
    private final static int questId = 25687;
	
    public _25687Kanker_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806106).addOnAtDistanceEvent(questId);
    }

...
public class _25683Roebe_Orders extends QuestHandler
{
    private final static int questId = 25683;
	
    public _25683Roebe_Orders() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(806107).addOnAtDistanceEvent(questId);
    }

...
public class _25579Put_Out_The_Lights extends QuestHandler
{
    private final static int questId = 25579;
	
    public _25579Put_Out_The_Lights() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(241235).addOnKillEvent(questId);
    }

...
public class _30341Improved_Bow extends QuestHandler
{
	private final static int questId = 30341;
	
	public _30341Improved_Bow() {
		super(questId);
	}
	...
	public void register() {
		...
		qe.registerGetingItem(182209739, questId);
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			...
			if (targetId == 799336) { //Tataka.
				if (dialog == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182209739, 1);
			...
			switch (targetId) {
				case 215795: { //Debilkarim The Maker.
					if (QuestService.collectItemCheck(env, true)) {
						return giveQuestItem(env, 182209739, 1);
					}
				}
			}
		}

...
public class _18627Kaliga_Collection_Shield extends QuestHandler
{
	private final static int questId = 18627;
	
	public _18627Kaliga_Collection_Shield() {
		super(questId);
	}
	
	@Override
	public void register() {
		qe.registerQuestNpc(730335).addOnQuestStart(questId); //Kaliga's Shield Rack.
		qe.registerQuestNpc(730335).addOnTalkEvent(questId); //Kaliga's Shield Rack.
	}
	...
	public boolean onCanAct(QuestEnv env, QuestActionType questEventType, Object... objects) {
		...
		if (targetId == 730335) { //Kaliga's Shield Rack.

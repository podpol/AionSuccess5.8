...
public class _28648Kaliga_Collection_Cipher_Blade extends QuestHandler
{
	private final static int questId = 28648;
	
	public _28648Kaliga_Collection_Cipher_Blade() {
		super(questId);
	}
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 730887) { //Kaliga's Cipher-Blade Rack.
			...
			if ((playerClass == PlayerClass.TECHNIST || playerClass == PlayerClass.AETHERTECH) && player.getCommonData().getRace() == Race.ASMODIANS) {
				if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {

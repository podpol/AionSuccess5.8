...
public class _18624Kaliga_Collection_Staff extends QuestHandler
{
	private final static int questId = 18624;
	
	public _18624Kaliga_Collection_Staff() {
		super(questId);
	}
	...
	public boolean onCanAct(QuestEnv env, QuestActionType questEventType, Object... objects) {
		...
		if (targetId == 730332) { //Kaliga's Staff Rack.
	...
	public boolean onDialogEvent(QuestEnv env) {
		...
		if (targetId == 730332) { //Kaliga's Staff Rack.
			...
			if ((playerClass == PlayerClass.PRIEST || playerClass == PlayerClass.CHANTER ||
			    playerClass == PlayerClass.CLERIC) && player.getCommonData().getRace() == Race.ELYOS) {
				if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {

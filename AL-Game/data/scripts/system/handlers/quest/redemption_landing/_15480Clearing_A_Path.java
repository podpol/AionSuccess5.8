...
public class _15480Clearing_A_Path extends QuestHandler
{
    private final static int questId = 15480;
	private static final Set<Integer> ab1BLv8L;
	
    public _15480Clearing_A_Path() {
        super(questId);
    }
	
	static {
		ab1BLv8L = new HashSet<Integer>();
		ab1BLv8L.add(805805);
		ab1BLv8L.add(805806);
		ab1BLv8L.add(805807);
		ab1BLv8L.add(805808);
	...
	public void register() {
		Iterator<Integer> iter = ab1BLv8L.iterator();
		while (iter.hasNext()) {
			int ab1Id = iter.next();

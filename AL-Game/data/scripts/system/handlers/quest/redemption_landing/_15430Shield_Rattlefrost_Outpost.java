...
public class _15430Shield_Rattlefrost_Outpost extends QuestHandler
{
    private final static int questId = 15430;
	
    public _15430Shield_Rattlefrost_Outpost() {
        super(questId);
    }
    ...
    public void register() {
		...
		qe.registerQuestNpc(882981).addOnKillEvent(questId);
		qe.registerQuestNpc(882982).addOnKillEvent(questId);
		qe.registerQuestNpc(882983).addOnKillEvent(questId);

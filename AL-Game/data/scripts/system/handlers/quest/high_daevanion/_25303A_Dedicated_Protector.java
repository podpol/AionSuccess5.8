			...
			if (targetId == 805340) {
				switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						giveQuestItem(env, 182215873, 1); //Daevanion Pauldron Prototype.
						removeQuestItem(env, 152003018, 150); //Pernon's Dew.
						removeQuestItem(env, 182215848, 40); //Marchutan's Pattern Of Devotion.
						removeQuestItem(env, 182215890, 50); //Spring Agrint Leaf.
						removeQuestItem(env, 182215891, 50); //Winter Agrint Leaf.

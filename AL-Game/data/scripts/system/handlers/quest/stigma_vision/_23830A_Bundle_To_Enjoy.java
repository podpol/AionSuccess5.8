...
public class _23830A_Bundle_To_Enjoy extends QuestHandler
{
	...
	public void register() {
		...
		qe.registerQuestItem(182216123, questId); //�?�?�모니움 보급품 안내서1.
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (zoneName == ZoneName.get("VIFROST_BRIDGE_120010000")) {
				if (var == 0) {
					...
					"I'am Aud stigma's master and I expect you at Pandaemonium. Come join me.", 182216123, 1, 0, 0, LetterType.NORMAL); //�?�?�모니움 보급품 안내서1.
					return true;
				}
			}
		}

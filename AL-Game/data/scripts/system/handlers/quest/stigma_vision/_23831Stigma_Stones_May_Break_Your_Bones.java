...
public class _23831Stigma_Stones_May_Break_Your_Bones extends QuestHandler
{
	...
	public void register() {
		...
		qe.registerQuestItem(182216124, questId); //�?�?�모니움 보급품 안내서2.
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (zoneName == ZoneName.get("VIFROST_BRIDGE_120010000")) {
				if (var == 0) {
					...
					"I'am Aud stigma's master and I expect you at Pandaemonium. Come join me.", 182216124, 1, 0, 0, LetterType.NORMAL); //�?�?�모니움 보급품 안내서2.
					return true;
				}
			}
		}

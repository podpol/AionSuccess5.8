...
public class _13832StiGreat extends QuestHandler
{
	...
	public void register() {
		...
		qe.registerQuestItem(182216120, questId); //엘리시움 지�?품 안내서3.
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (zoneName == ZoneName.get("EXALTED_PATH_110010000")) {
				if (var == 0) {
					...
					"I'am Miriya a stigma's master and I expect you at Sanctum. Come join me.", 182216120, 1, 0, 0, LetterType.NORMAL); //엘리시움 지�?품 안내서3.
					return true;
				}
				...
				if (var == 0) {
					...
					"I'am a stigma's master and I expect you in a Fortress. Come join me.", 182216120, 1, 0, 0, LetterType.NORMAL); //엘리시움 지�?품 안내서3.
					return true;
				}
			}
		}

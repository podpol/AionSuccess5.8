...
public class _23833You_Aud_A_Know extends QuestHandler
{
	...
	public void register() {
		...
		qe.registerQuestItem(182216126, questId); //�?�?�모니움 보급품 안내서4.
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (zoneName == ZoneName.get("VIFROST_BRIDGE_120010000")) {
				if (var == 0) {
					...
					"I'am Aud a stigma's master and I expect you at Pandaemonium. Come join me.", 182216126, 1, 0, 0, LetterType.NORMAL); //�?�?�모니움 보급품 안내서4.
					return true;
				}
				...
				if (var == 0) {
					...
					"I'am a stigma's master and I expect you in a Fortress. Come join me.", 182216126, 1, 0, 0, LetterType.NORMAL); //�?�?�모니움 보급품 안내서4.
					return true;
				}
			}
		}

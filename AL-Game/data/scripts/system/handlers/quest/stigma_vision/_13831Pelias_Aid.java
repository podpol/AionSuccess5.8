...
public class _13831Pelias_Aid extends QuestHandler
{
    private final static int questId = 13831;
	
    public _13831Pelias_Aid() {
        super(questId);
    }
	...
	public void register() {
		...
		qe.registerQuestItem(182216119, questId); //엘리시움 지�?품 안내서2.
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (zoneName == ZoneName.get("EXALTED_PATH_110010000")) {
				if (var == 0) {
					...
					"I'am Miriya stigma's master and I expect you at Sanctum. Come join me.", 182216119, 1, 0, 0, LetterType.NORMAL); //엘리시움 지�?품 안내서2.
					return true;
				}
			}
		}

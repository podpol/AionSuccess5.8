...
public class _13834StigMajor extends QuestHandler
{
    private final static int questId = 13834;
	
    public _13834StigMajor() {
        super(questId);
    }
	...
	public void register() {
		...
		qe.registerQuestItem(182216122, questId); //엘리시움 지�?품 안내서5.
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (zoneName == ZoneName.get("EXALTED_PATH_110010000")) {
				if (var == 0) {
					...
					"I'am Miriya stigma's master and I expect you at Sanctum. Come join me.", 182216122, 1, 0, 0, LetterType.NORMAL); //엘리시움 지�?품 안내서5.
					return true;
				}
			}
		}

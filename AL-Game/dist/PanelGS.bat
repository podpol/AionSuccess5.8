...
SET JAVA_OPTS=-Xms3072m -Xmx16g -XX:MaxHeapSize=16gm -Xdebug -ea -XX:-UseSplitVerifier -XX:+UseThreadPriorities -XX:ThreadPriorityPolicy=1 -Xrunjdwp:transport=dt_socket,address=8998,server=y,suspend=n -ea
CALL StartGS.bat
)
IF %OPTION% == 2 (
SET MODE=PRODUCTION

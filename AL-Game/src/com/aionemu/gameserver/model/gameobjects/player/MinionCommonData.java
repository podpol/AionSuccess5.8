...
public class MinionCommonData extends VisibleObjectTemplate implements IExpirable {
    ...
    public MinionCommonData(int minionId, int masterObjectId, String name, String grade, int minionLevel, int miniongrowthpoint, int expireTime) {
        this.minionObjId = IDFactory.getInstance().nextId();
        this.minionId = minionId;
        this.masterObjectId = masterObjectId;
        this.name = name;
        this.minionGrade = grade;
    ...
    public void expireEnd(Player player) {
        ...
        PacketSendUtility.sendPacket(player, SM_SYSTEM_MESSAGE.STR_MSG_PET_ABANDON_EXPIRE_TIME_COMPLETE(this.name));
        PetAdoptionService.surrenderPet(player, this.minionId);
    }
    @Override

...
public abstract class PlayerMinionsDAO implements DAO {
	...
	public abstract void removePlayerMinion(Player player, int minionObjId, Timestamp timestamp);
	...
	public abstract void updatePlayerMinionGrowthPoint(MinionCommonData minionCommonData);
	...
	public abstract void saveDopingBag(Player player, int minionObjId, MinionDopingBag bag);

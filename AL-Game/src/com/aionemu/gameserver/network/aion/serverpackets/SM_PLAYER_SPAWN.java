...
public class SM_PLAYER_SPAWN extends AionServerPacket
{
	...
	protected void writeImpl(AionConnection con) {
		...
		//[LIVE_Party_Match_Boost 60+]
		else if ((player.getWorldId() == 300220000 ||
		    player.getWorldId() == 300510000 || player.getWorldId() == 300520000 ||
			...
			//[Occupied] Rentus Base. & [Anguished] Dragon Lord's Refuge. & Raksang Ruins. & Danuar Sanctuary.

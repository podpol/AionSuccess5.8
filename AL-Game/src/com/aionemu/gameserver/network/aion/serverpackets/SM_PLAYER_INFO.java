...
public class SM_PLAYER_INFO extends AionServerPacket
{
	...
	protected void writeImpl(AionConnection con) {
		 ...
		 */
		if (player.isMarried()) {
			String partner = ((PlayerDAO)DAOManager.getDAO(PlayerDAO.class)).getPlayerNameByObjId(player.getPartnerId());
			nameFormat = nameFormat +"\uE020"+ partner;
		}

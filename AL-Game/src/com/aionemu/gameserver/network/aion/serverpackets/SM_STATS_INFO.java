...
public class SM_STATS_INFO extends AionServerPacket
{
	...
	protected void writeImpl(AionConnection con) {
		...
		writeH(pgs.getMainHandMAttack().getCurrent());
		writeF(pgs.getAttackRange().getCurrent() / 1000.0F); //Original Value
		...
		writeH(pgs.getMaxDp().getBase());//5.3
		writeH(0);//5.3
		...
		writeF(pgs.getAttackRange().getBase() / 1000f);// attack range - Original Value

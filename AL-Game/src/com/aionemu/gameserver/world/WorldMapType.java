...
public enum WorldMapType
{
	...
	//Balaurea
	INGGISON_MASTER(210130000),
	CYGNEA(210070000),
	GRIFFOEN(210080000),
	IDIAN_DEPTHS_L(210090000),
	GELKMAROS_MASTER(220140000),
	ENSHAR(220080000),
	HABROK(220090000),
	IDIAN_DEPTHS_D(220100000),
	SILENTERA_CANYON(600010000),
	SILENTERA_CANYON_MASTER(600110000),
	TIAMARANTA_EYE(600040000),
	TIAMARANTA_EYE_MASTER(600041000),

	//Maps 4.3
	SARPAN(600020000), //Need Client Patch!
	TIAMARANTA(600030000), //Need Client Patch!
	KATALAM(600050000), //Need Client Patch!
	DANARIA(600060000), //Need Client Patch!
	ELEMENTIS_FOREST(300260000), //Need Client Patch!
	...
	EVENT_ATURAM_SKY_FORTRESS(300241000),
	...
	EVENT_CONTAMINED_UNDERPATH(301631000),
	IDEVENT_DEF_H(301632000),
	SECRET_MUNITIONS_FACTORY(301640000),
	
	//Map 5.1
	CRADLE_OF_ETERNITY(301550000),
	TRIALS_OF_ETERNITY(301560000),
	...
	OPPORTUNITY_FISSURE_OF_OBLIVION(302110000),
	
	//Map 5.3
	ARENA_OF_TENACITY(302310000),
	HALL_OF_TENACITY(302320000),
	KUMUKI_CAVE(302330000),
	DREDGION_DEFENSE_SANCTUM(302200000),
	DREDGION_DEFENSE_PANDAEMONIUM(302300000),
	
	//Map 5.5
	BASTION_OF_SOULS(302340000),
	EVERGALE_CANYON(302350000),
	
	//Map 5.6
	IDTM_ARENA_E_01(302360000),
	IDTM_LOBBY_E_01(302370000),
	IDTM_ARENA_P_01(302380000),
	IDTM_LOBBY_P_01(302390000),
	CRUCIBLE_SPIRE(302400000),
	IDTM_ARENA_P_02(302410000),
	IDTM_LOBBY_P_02(302420000),
	
	//Map 5.8
	IDRUN(301700000),
	IDABRE_CORE_03(301720000),
	IDAB1_HEROES_L(310160000),
	IDAB1_HEROES_D(320160000),
